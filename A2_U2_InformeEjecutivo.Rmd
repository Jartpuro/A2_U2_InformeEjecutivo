...
# Cargar librerías necesarias para gráficos de efectos parciales
install.packages("effects")
library(effects)

# Cargar el paquete lmtest para pruebas estadísticas
library(lmtest)

# Cargar la librería plotly para gráficos interactivos
