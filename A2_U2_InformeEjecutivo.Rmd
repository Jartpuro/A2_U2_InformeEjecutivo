...
required_packages <- c("paqueteMODELOS", "leaflet", "ggplot2", "effects", "plotly", "leaflet.extras", "dplyr", "lmtest", "corrplot", "tidyverse", "skimr")
...
# Histograma y gráficos de densidad para el precio de los apartamentos
ggplot(vivienda_apartamento, aes(x = preciom)) +
...
# Se puede probar el test de Breusch-Pagan para la heterocedasticidad
bptest(modelo_regresion)

# También se puede evaluar la autocorrelación de los residuos utilizando el test de Ljung-Box
Box.test(modelo_regresion$resid, type = "Ljung-Box")
