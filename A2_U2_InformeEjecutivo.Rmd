...
## 2. EDA Correlación de la variable precio de la casa en función del área construida, estrato, numero de baños, numero de habitaciones y zona donde se ubica la vivienda


```{r , warning=FALSE, message=FALSE, echo=FALSE}

# Convertir la variable 'zona' a un factor
vivienda$zona <- as.factor(vivienda$zona)

# Calcular la correlación entre las variables de interés
correlation_matrix <- cor(vivienda[, c("preciom", "areaconst", "estrato", "banios", "habitaciones")])

# Crear una matriz de correlación interactiva con plotly
